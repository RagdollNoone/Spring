...
public class Utils {
    ...
    public static BufferedReader getBufferedReaderOldFashionedly(final String resourceName) throws Exception {
        InputStream inStream = new FileInputStream(resourceName);
        return new BufferedReader(new InputStreamReader(inStream));
    }

    public static BufferedReader getBufferedReaderByNIO(final String resourceName) throws Exception {
