...
import com.advance.busivo.User;
import com.advance.busivo.UserContact;
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (msg == null) {
                ...
                user.setId("No:1");
                user.setUserContact(new UserContact(userName+"@tuling.com", "133"));
                ...
                user.setUserName(userName);
                user.setId("No:1");
                user.setUserContact(new UserContact(userName+"@tuling.com", "331"));
